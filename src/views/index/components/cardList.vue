    ...
    <a-row :gutter="24">
      <a-col :xs="12" :md="12" :sm="12" :lg="6">
        <div class="card-item card-item-one" @click="sendTitle('销售额', 'sale')">
          <div class="card-title">
            <a-space :size="8"> <svg-icon icon="sale" :size="20" /> 在线人数 </a-space>
          </div>
          <div class="all-count">
      ...
      <a-col :xs="12" :md="12" :sm="12" :lg="6">
        <div class="card-item card-item-two" @click="sendTitle('访问量', 'visit')">
          <div class="card-title">
            <a-space :size="8"> <svg-icon icon="visit" :size="20" /> 人审总量 </a-space>
          </div>
          <div class="all-count">
      ...
      <a-col :xs="12" :md="12" :sm="12" :lg="6">
        <div class="card-item card-item-three" @click="sendTitle('加购数', 'shopCard')">
          <div class="card-title">
            <a-space :size="8"> <svg-icon icon="shopCard" :size="20" /> 参与团队 </a-space>
          </div>
          <div class="all-count">
            <count-to :startVal="0" :endVal="4" :duration="2200" />
      ...
      <a-col :xs="12" :md="12" :sm="12" :lg="6">
        <div class="card-item card-item-four" @click="sendTitle('支付数', 'pay')">
          <div class="card-title">
            <a-space :size="8"> <svg-icon icon="pay" :size="20" /> 业务个数 </a-space>
          </div>
          <div class="all-count">
            <count-to :startVal="0" :endVal="6" :duration="2200" />
            <span class="suffix">个</span>
          </div>
          <div class="card-info relative">
            <div class="abs-bottom">
